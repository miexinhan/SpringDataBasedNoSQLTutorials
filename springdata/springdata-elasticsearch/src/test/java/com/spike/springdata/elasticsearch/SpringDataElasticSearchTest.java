...
//	}
	...
	public void testCreate() throws ParseException {
		...
		List<BookDoc> docs = //
		Arrays.asList(
				new BookDoc(1L, "中国新闻", "中国驻洛杉矶领事馆遭亚裔男子枪击,嫌犯已自首", new Double(10.3), new Date()), //
				new BookDoc(2L, "北京新闻", "北京校车将享最高路权", new Double(11.3), new DateTime().plusDays(1).toDate()), //
				new BookDoc(3L, "中国新闻", "公安部：昆明砍人事件是外疆独干的", new Double(12.3), new DateTime().plusDays(2).toDate()), //
				new BookDoc(4L, "国际新闻", "美国留给伊拉克的是个烂摊子吗", new Double(13.3), new DateTime().plusDays(3).toDate()), //
				new BookDoc(5L, "国际新闻", "中韩渔警冲突调查：韩警平均每天扣1艘中国渔船", new Double(14.3), new DateTime().plusDays(4).toDate()));
