 ...
 *
 */
public class CustomedRepositoryImpl<T, ID extends Serializable> extends SimpleJpaRepository<T, ID> implements
		CustomedRepository<T, ID> {
	...
	/**
	 * Creates a new {@link CustomedRepositoryImpl} to manage objects of the
