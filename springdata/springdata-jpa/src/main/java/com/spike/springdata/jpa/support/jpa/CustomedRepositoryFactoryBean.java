 ...
 * 
 */
public class CustomedRepositoryFactoryBean<R extends JpaRepository<T, I>, T, I extends Serializable> extends
	 ...
	 *
	 */
	private static class CustomedRepositoryFactory<T, I extends Serializable> extends JpaRepositoryFactory {
