package com.spike.springdata.jpa.extension;
...
public class NamingStrategyExtension implements NamingStrategy, Serializable {

  /**
   * A convenient singleton instance
   */
  public static final NamingStrategy INSTANCE = new NamingStrategyExtension();
  ...
  /**
   * override ImprovedNamingStrategy#addUnderscores
   * @param name
   * @return
   */
  ...
  /**
   * Returns either the table name if explicit or if there is an associated table, the concatenation
   * of owner entity table and associated table otherwise the concatenation of owner entity table
   * and the unqualified property name
   */
  ...
  /**
   * Return the column name if explicit or the concatenation of the property name and the referenced
   * column
   */
