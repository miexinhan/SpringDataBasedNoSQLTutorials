...
public class SpringDataBookProdTest {
  ...
  public void populateGraph() {
    ...
    tags.add(tag);
    Product iPad =
        productRepository.save(new Product("iPad", "Apple tablet device", BigDecimal.valueOf(499),
            tags));
    Product mbp =
        productRepository.save(new Product("MacBook Pro", "Apple notebook", BigDecimal
            .valueOf(1299), tags));
