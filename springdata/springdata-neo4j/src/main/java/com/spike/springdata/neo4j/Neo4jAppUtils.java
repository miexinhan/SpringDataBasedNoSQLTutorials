...
public class Neo4jAppUtils {
	...
	public static void createNodeIndex(GraphDatabaseService gds, String indexName, Node node, String indexKey,
			Object indexValue) {
	...
	public static Node searchWithNodeIndex(GraphDatabaseService gds, String indexName, String indexKey,
			String indexValue) {
	...
	public static List<Node> searchWithNodeIndex(GraphDatabaseService gds, String indexName, String indexKey,
			Object indexValue) {
		List<Node> result = new ArrayList<Node>();
