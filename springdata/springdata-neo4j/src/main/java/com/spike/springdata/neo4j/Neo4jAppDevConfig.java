...
@EnableNeo4jRepositories(
    excludeFilters = { @Filter(value = { Neo4jTransactionManagerConfig.class }) })
public class Neo4jAppDevConfig extends Neo4jConfiguration {
  ...
  public GraphDatabaseService graphDatabaseService() {
    ...
    GraphDatabaseService result =
        new GraphDatabaseFactory().newEmbeddedDatabaseBuilder(Embedded_DB_DIR)
            .setConfig(GraphDatabaseSettings.node_auto_indexing, "true")
            .setConfig(GraphDatabaseSettings.relationship_auto_indexing, "true")
            .setConfig(GraphDatabaseSettings.node_keys_indexable, "name, dateOfBirth")
            .setConfig(GraphDatabaseSettings.relationship_keys_indexable, "type, name")
            .newGraphDatabase();
