 ...
 * </pre>
 * 
 * @see com.mongodb.client.MongoCollection#updateOne(org.bson.conversions.Bson, org.bson.conversions.Bson)
 * @see com.mongodb.client.MongoCollection#updateOne(org.bson.conversions.Bson, org.bson.conversions.Bson,
 *      com.mongodb.client.model.UpdateOptions)
 * @see com.mongodb.client.MongoCollection#updateMany(org.bson.conversions.Bson, org.bson.conversions.Bson)
 * @see com.mongodb.client.MongoCollection#updateMany(org.bson.conversions.Bson, org.bson.conversions.Bson,
 *      com.mongodb.client.model.UpdateOptions)
...
public class UpdateDataApp {
	...
	static void _1_2_updateNestedField(MongoCollection<Document> mongoCollection) {
		...
		// 2 更新
		Document updateDocument = new Document("$set", new Document("address.street", "East 31st Street."));
		UpdateResult updateResult = mongoCollection.updateOne(filterDocument, updateDocument);
		System.out.println(updateResult);
